...
TEACHER_ACCOUNTS = [
    {"email": "teacher1@school.com", "phone": "9100000001", "name": "Dr. Suresh Kumar",
     "gender": "Male", "designation": "Senior Teacher", "department": "Science", "experience": 15},
    {"email": "teacher2@school.com", "phone": "9100000002", "name": "Mrs. Anita Deshpande",
     "gender": "Female", "designation": "HOD", "department": "Mathematics", "experience": 12},
    {"email": "teacher3@school.com", "phone": "9100000003", "name": "Mr. Rakesh Singh",
     "gender": "Male", "designation": "Teacher", "department": "English", "experience": 8},
    {"email": "teacher4@school.com", "phone": "9100000004", "name": "Mrs. Preeti Sharma",
     "gender": "Female", "designation": "Teacher", "department": "Hindi", "experience": 10},
    {"email": "teacher5@school.com", "phone": "9100000005", "name": "Mr. Abhay Deshmukh",
     "gender": "Male", "designation": "Teacher", "department": "Social Studies", "experience": 6},
    {"email": "teacher6@school.com", "phone": "9100000006", "name": "Mrs. Nandini Patil",
     "gender": "Female", "designation": "Senior Teacher", "department": "Science", "experience": 14},
]
...
async def create_user(db, email, phone, name, role, extra=None):
    ...
    if role == UserRole.ADMIN:
        ...
        await db.refresh(user)
        db.add(AdminProfile(
            user_id=user.id, admin_name=name,
        ...
        db.add(TeacherProfile(
            user_id=user.id, teacher_name=name,
        ...
        db.add(StudentProfile(
            user_id=user.id, student_name=name,
            gender=Gender.MALE if gender == "Male" else Gender.FEMALE,
        ))
        ...
        try:
            ...
            for acc in ADMIN_ACCOUNTS:
                user = await create_user(
                    db, acc["email"], acc["phone"], acc["name"],
                    UserRole.ADMIN, {"super_admin": acc.get("super_admin", False)},
                )
                if user:
            ...
            for acc in STUDENT_ACCOUNTS:
                user = await create_user(
                    db, acc["email"], acc["phone"], acc["name"],
                    UserRole.STUDENT, {"gender": acc["gender"]},
                )
                if user:
